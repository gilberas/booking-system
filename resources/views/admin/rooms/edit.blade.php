<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 mb-0">Edit Room {{ $room->room_number }} — {{ $roomType->name }} ({{ $hotel->name }})</h2>
    </x-slot>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.hotels.room-types.rooms.update', [$hotel, $roomType, $room]) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="floor" class="form-control @error('floor') is-invalid @enderror" value="{{ old('floor', $room->floor) }}" required>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-navy">Update Room</button>
                </div>
            </form>
        </div>
    </div>
